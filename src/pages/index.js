      ...
      <div className="container flex flex-col items-center">
        ...
        <div className="align-left">
          ...
          <div className="flex gap-4 mt-12">
            <a
              className="bg-accent-primary border border-accent-primary px-6 py-3 rounded text-sm font-bold cursor-pointer text-nowrap"
              href="/docs/intro"
            >
              Get Started
            </a>
            <a
              className="bg-cobalt-800 border border-gray-500 px-6 py-3 rounded text-sm font-bold cursor-pointer text-nowrap"
  ...
  return (
    <div className="twp container mx-auto grid grid-cols-2 gap-6 sm:gap-0 sm:grid-cols-3 my-10">
      <div className="flex flex-col justify-self-center">
        <p className="font-bold mb-2">Papers</p>
        <a
          className="text-accent-primary font-medium"
          href="/docs/whitepaper/antitoken"
        >
          Antitoken <span className="text-gray-500 text-xs">(white)</span>
        </a>
        <a
          className="text-accent-primary font-medium"
          href="/docs/yellowpaper/antitoken"
        >
          Antitoken <span className="text-gray-500 text-xs">(yellow)</span>
        </a>
        <a
          className="text-accent-primary font-medium"
      ...
      <div className="flex flex-col justify-self-center">
        ...
        <a
          className="text-accent-primary font-medium flex items-center gap-2"
      ...
      <div className="flex flex-col justify-self-center">
        ...
        >
          ...
          <span className="text-gray-500 text-xs">lite.antitoken.pro</span>
        </a>
        <a
          className="text-accent-primary font-medium flex items-center gap-2"
        ...
        >
          ...
          <span className="text-gray-500 text-xs">app.antitoken.pro</span>
        </a>
        <a
          className="text-accent-primary font-medium flex items-center gap-2"
        ...
        >
          ...
          <span className="text-gray-500 text-xs">poll.antitoken.pro</span>
        </a>
      </div>
    </div>
  );
